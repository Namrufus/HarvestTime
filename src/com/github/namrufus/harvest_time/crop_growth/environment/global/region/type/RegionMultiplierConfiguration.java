...
public class RegionMultiplierConfiguration {
	List<RegionPreference> preferences;
	List<RegionState> states;
	
	Map<RegionPreference, Map<RegionState, Double>> multipliers;
	
	public RegionMultiplierConfiguration(List<RegionPreference> preferences, List<RegionState> states, ConfigurationSection config, Logger LOG) {
