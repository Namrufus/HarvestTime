...
public class RegionSamplerUtil {
	...
	private static class CompactnessSampler implements Sampler {
		...
		public CompactnessSampler(RegionalGenerator regionalGenerator) {
	...
	private static class PhSampler implements Sampler {
		...
		public PhSampler(RegionalGenerator regionalGenerator) {
			this.regionalGenerator = regionalGenerator;
		}
	...
	private static class NutrientsSampler implements Sampler {
		...
		public NutrientsSampler(RegionalGenerator regionalGenerator) {
			this.regionalGenerator = regionalGenerator;
		}
	...
	public static void sampleCompactnessImage(int imageSize, double scale, RegionalGenerator regionalGenerator, File outputFile, Logger log) {
		Sampler sampler = new CompactnessSampler(regionalGenerator);
		sampleImage(imageSize, scale, sampler, outputFile, log);
	}
	public static void samplePhImage(int imageSize, double scale, RegionalGenerator regionalGenerator, File outputFile, Logger log) {
		Sampler sampler = new PhSampler(regionalGenerator);
		sampleImage(imageSize, scale, sampler, outputFile, log);
	}
	public static void sampleNutrientsImage(int imageSize, double scale, RegionalGenerator regionalGenerator, File outputFile, Logger log) {
